      ...
      <ul className="flex justify-center items-center gap-8">
        {
          technologies.map((tech) => (
            <li className="p-4 rounded-lg bg-white shadow-md font-montserrat-bold">{tech}</li>
          ))
        }
      </ul>
      <ul className="flex justify-center items-center gap-8 mt-4">
        <li className="font-montserrat-bold">
          <a href={codelink} target='_blank' rel="noreferrer" className='flex justify-center items-center gap-2'>
            <FontAwesomeIcon icon={faGithub} size='2x'/> Code
          </a>
        </li>
        <li className="font-montserrat-bold">
          <a href={demolink} target='_blank' rel="noreferrer" className='flex justify-center items-center gap-2'>
