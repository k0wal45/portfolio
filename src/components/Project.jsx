  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 max-w-[35rem] gap-8">
        ...
        <img
          src={bezpieczni2}
          alt="Logo Bezpieczni w teorii"
          className="rounded-xl object-cover aspect-square"
        />
        <img
          src={bezpieczni1}
          alt="Logo Bezpieczni w teorii"
          className="rounded-xl col-span-2 max-h-[20rem] w-full object-cover"
        />
      </div>
      <div className="flex flex-col items-start justify-center gap-4 max-w-xl">
        <h2 className="font-bold text-xl font-montserrat-black text-primary bg-primary bg-opacity-30 p-4 w-fit">
        ...
        <a
          href="https://bezpieczniwteorii.pl/"
